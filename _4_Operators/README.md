...
An **operator** is a symbol that performs an operation on one or more values. For example, in `a + b`, the `+` is an operator and `a` and `b` are operands. Operators are how you actually *do* something with the data you stored in Chapter 3.

This chapter is split into three small programs:

| File | Topic |
|------|-------|
| `_4_1_Arithmetic_Operators_Code.java`  | `+ - * / %` and `++ --` |
| `_4_2_Assignment_Operators_Code.java`  | `=` and `+= -= *= /= %=` |
| `_4_3_Logical_Operators_Code.java`     | `&& || !` and relational operators |
...
- **Ternary** – three operands (the `? :` operator, covered in Chapter 5)
...
```bash
javac _4_Operators/_4_1_Arithmetic_Operators_Code.java
java _4_Operators._4_1_Arithmetic_Operators_Code

javac _4_Operators/_4_2_Assignment_Operators_Code.java
java _4_Operators._4_2_Assignment_Operators_Code

javac _4_Operators/_4_3_Logical_Operators_Code.java
java _4_Operators._4_3_Logical_Operators_Code
```
...
*This is part of a Java learning series. Proceed to Chapter 5: Conditional Statements to continue learning.*
