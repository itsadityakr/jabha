# Chapter 14: The `final` Keyword in Java
...
| File | Demonstrates |
|------|--------------|
| `_14_1_final_Variable_Code.java` | `final` variables (constants and final references) |
| `_14_2_final_Class_Code.java`    | `final` classes (cannot be extended)               |
| `_14_3_final_Method_Code.java`   | `final` methods (cannot be overridden)             |
...
public class _14_1_final_Variable_Code {
...
public class _14_2_final_Class_Code {
    public static void main(String[] args) {
...
public class _14_3_final_Method_Code {
    public static void main(String[] args) {
        B b = new B();
...
All three files declare `package _14_final_Keyword;`. Compile and run them from the parent directory using the package path:

```bash
# Final variable demo
javac _14_final_Keyword/_14_1_final_Variable_Code.java
java _14_final_Keyword._14_1_final_Variable_Code

# Final class demo
javac _14_final_Keyword/_14_2_final_Class_Code.java
java _14_final_Keyword._14_2_final_Class_Code

# Final method demo (override in B is commented out, so it prints "A show")
javac _14_final_Keyword/_14_3_final_Method_Code.java
java _14_final_Keyword._14_3_final_Method_Code
```

> In `_14_3_final_Method_Code.java`, `B`'s `show()` override is commented out, so the file compiles and prints `A show`. Uncommenting that override produces the compile-time error "overriding method is final" -- which is the lesson the example teaches.
...
A subclass cannot override a `final` method (as `_14_3_final_Method_Code.java` shows). The compiler rejects it. To allow overriding, remove `final` from the parent method.
...
**Answer:** The code fails to compile with an error such as "overridden method is final". The subclass is not permitted to provide a new implementation. This is exactly what `_14_3_final_Method_Code.java` demonstrates.
...
*This is part of a Java learning series. It builds on Chapter 11: Inheritance and Chapter 13: Polymorphism, since `final` methods and classes directly control overriding and inheritance.*
