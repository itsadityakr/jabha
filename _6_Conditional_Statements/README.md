...
| File | Topic |
|------|-------|
| `_6_1_If_Else_Code.java`  | `if`, `if-else`, `if-else-if`, nested `if` |
| `_6_2_Ternary_Code.java`  | The `? :` ternary operator |
| `_6_3_Switch_Code.java`   | The `switch` statement |

---

## What is a Conditional Statement

A conditional statement evaluates a **boolean condition** (something that is `true` or `false`, built using the relational and logical operators from Chapter 5) and chooses which block of code to run.
...
```bash
javac _6_Conditional_Statements/_6_1_If_Else_Code.java
java _6_Conditional_Statements._6_1_If_Else_Code

javac _6_Conditional_Statements/_6_2_Ternary_Code.java
java _6_Conditional_Statements._6_2_Ternary_Code

javac _6_Conditional_Statements/_6_3_Switch_Code.java
java _6_Conditional_Statements._6_3_Switch_Code
```
...
*This is part of a Java learning series. Proceed to Chapter 7: Loops to continue learning.*
