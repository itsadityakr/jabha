# Chapter 12: Super and This Keywords in Java
...
public class _12_Super_and_This_Code {
...
The file declares `package _12_Super_and_This;`, so compile and run from the
parent directory using the package path:

```bash
javac _12_Super_and_This/_12_Super_and_This_Code.java
java _12_Super_and_This._12_Super_and_This_Code
```
