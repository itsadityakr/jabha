# Chapter 8: Arrays with Object Properties
...
public class _8_Arrays_Properties_Code {
...
```bash
javac _8_Arrays_Properties_Code.java
java _8_Arrays_Properties_Code
```
...
*This is part of a Java learning series. Proceed to Chapter 9: Encapsulation to continue learning.*
