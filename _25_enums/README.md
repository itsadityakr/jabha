...
| File | Topic |
|------|-------|
| `_25_1_enums_Code.java` | A basic enum, its methods, comparison, and use in `switch` |
| `_25_2_enums_Code.java` | An enum with fields, constructors, and methods |
...
```bash
javac _25_enums/_25_1_enums_Code.java
java _25_enums._25_1_enums_Code

javac _25_enums/_25_2_enums_Code.java
java _25_enums._25_2_enums_Code
```
