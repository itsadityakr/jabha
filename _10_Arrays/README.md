...
This chapter is split into four programs:

| File | Topic |
|------|-------|
| `_10_1_Arrays_Code.java`            | Declaring, instantiating, and traversing a 1D array |
| `_10_2_Enhanced_For_Loop_Code.java` | The enhanced `for-each` loop over arrays |
| `_10_3_TwoD_Array_Code.java`        | Two-dimensional (grid/matrix) arrays |
| `_10_4_Jagged_Array_Code.java`      | Jagged arrays (rows of different lengths) |
...
```java
public class _10_1_Arrays_Code {
...
javac _10_Arrays/_10_2_Enhanced_For_Loop_Code.java
java _10_Arrays._10_2_Enhanced_For_Loop_Code

javac _10_Arrays/_10_3_TwoD_Array_Code.java
java _10_Arrays._10_3_TwoD_Array_Code

javac _10_Arrays/_10_4_Jagged_Array_Code.java
java _10_Arrays._10_4_Jagged_Array_Code
```

### Expected Output (`_10_1_Arrays_Code`)
...
*This is part of a Java learning series. Proceed to Chapter 11: Arrays with Object Properties to continue learning.*
