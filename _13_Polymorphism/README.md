# Chapter 13: Polymorphism in Java
...
public class _13_Polymorphism_Runtime_Code {
...
```bash
javac _13_Polymorphism_Runtime_Code.java
java _13_Polymorphism_Runtime_Code
```

> Note: The file declares `package _13_Polymorphism;`. If you compile from the parent directory, use:
>
> ```bash
> javac _13_Polymorphism/_13_Polymorphism_Runtime_Code.java
> java _13_Polymorphism._13_Polymorphism_Runtime
> ```
...
*This is part of a Java learning series. It builds on Chapter 11: Inheritance and Chapter 12: Super and This Keywords.*
