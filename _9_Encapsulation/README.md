# Chapter 9: Encapsulation in Java
...
public class _9_Encapsulation_Code {
...
```bash
javac _9_Encapsulation_Code.java
java _9_Encapsulation_Code
```
...
*This is part of a Java learning series. Proceed to Chapter 10: Static Keyword to continue learning.*
