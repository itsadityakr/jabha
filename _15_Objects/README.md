# Chapter 15: Objects and the Common `Object` Methods (`toString`, `equals`, `hashCode`)
...
The file declares `package _15_Objects;`, so compile and run from the parent directory using the package path:

```bash
javac _15_Objects/_15_Objects_Code.java
java _15_Objects._15_Objects_Code
```
