# Chapter 16: Casting (Type Casting, Upcasting, and Downcasting)
...
| File | Demonstrates |
|------|--------------|
| `_16_1_TypeCasting_Code.java` | Widening and narrowing of **primitive** types |
| `_16_2_UpCasting_Code.java`   | **Upcasting** a subclass object (`B`) to a superclass reference (`A`) |
| `_16_2_DownCasting_Code.java` | **Downcasting** a superclass reference (`A`) back to the subclass (`B`) |
...
### `_16_2_UpCasting_Code.java`

```java
public class _16_2_UpCasting_Code {
    static class A {
...
### `_16_2_DownCasting_Code.java`

```java
public class _16_2_DownCasting_Code {
    static class A {
        public void showA() { System.out.println("In Class A"); }
    }
    static class B extends A {
...
All three files declare `package _16_Casting;`. Because each file keeps its `A`
...
javac _16_Casting/*.java

# ...or one file at a time, e.g.:
# javac _16_Casting/_16_1_TypeCasting_Code.java

# Then run each program:
java _16_Casting._16_1_TypeCasting_Code
java _16_Casting._16_2_UpCasting_Code
java _16_Casting._16_2_DownCasting_Code
```
