# Chapter 19: Objects and the Common `Object` Methods (`toString`, `equals`, `hashCode`)
...
The file declares `package _19_Objects;`, so compile and run from the parent directory using the package path:

```bash
javac _19_Objects/_19_Objects_Code.java
java _19_Objects._19_Objects_Code
```
