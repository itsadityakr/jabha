# Chapter 3: Type Casting in Java
...
```java
public class _3_TypeCasting_Code {
...
```bash
javac _3_TypeCasting_Code.java
java _3_TypeCasting_Code
```
...
*This is part of a Java learning series. Proceed to Chapter 4: Data Types to continue learning.*
