# Chapter 20: Casting (Type Casting, Upcasting, and Downcasting)
...
| File | Demonstrates |
|------|--------------|
| `_20_1_TypeCasting_Code.java` | Widening and narrowing of **primitive** types |
| `_20_2_UpCasting_Code.java`   | **Upcasting** a subclass object (`B`) to a superclass reference (`A`) |
| `_20_2_DownCasting_Code.java` | **Downcasting** a superclass reference (`A`) back to the subclass (`B`) |
...
### `_20_2_UpCasting_Code.java`

```java
public class _20_2_UpCasting_Code {
    static class A {
...
### `_20_2_DownCasting_Code.java`

```java
public class _20_2_DownCasting_Code {
    static class A {
        public void showA() { System.out.println("In Class A"); }
    }
    static class B extends A {
...
All three files declare `package _20_Casting;`. Because each file keeps its `A`
...
javac _20_Casting/*.java

# ...or one file at a time, e.g.:
# javac _20_Casting/_20_1_TypeCasting_Code.java

# Then run each program:
java _20_Casting._20_1_TypeCasting_Code
java _20_Casting._20_2_UpCasting_Code
java _20_Casting._20_2_DownCasting_Code
```
